...
public class StreamLambdaHandlerTest {
  ...
  public void ping_streamRequest_respondsWithHello() {
    InputStream requestStream =
        new AwsProxyRequestBuilder("/ping", HttpMethod.GET)
  ...
  @Test
  public void welcome_streamRequest_respondsWithHello() {
    InputStream requestStream =
        new AwsProxyRequestBuilder("/welcome", HttpMethod.GET)
            .header(HttpHeaders.ACCEPT, MediaType.APPLICATION_JSON)
            .buildStream();
    ByteArrayOutputStream responseStream = new ByteArrayOutputStream();
    ...
    assertTrue(
        response
            .getBody()
            .contains("Welcome guest. This is a test template for Java Spring Boot Lambda!"));
